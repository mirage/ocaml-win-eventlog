...
(* OASIS_START *)
(* DO NOT EDIT (digest: 811adbc27b2d4600efdcaceea1fd8660) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "eventlog";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "examples";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "eventlog"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\007-VNi\019b}u\164p3e\182\172\188";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
