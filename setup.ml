...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9128fc268655b937bf5cd1adac34f99b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          license_file = None;
          copyrights = ["(C) 2016 Docker Inc"];
          maintainers = [];
          authors = ["David Scott"];
          homepage = None;
          synopsis = "Binding to the Windows event log API";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Eventlog"; "Log_eventlog"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "win-eventlog";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "Windows eventlog bindings";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "examples";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "win-eventlog"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "reporter.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\191\022pu\209\186d\216\205\235T\171j\142\237v";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
